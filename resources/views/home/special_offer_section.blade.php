            ...
            <div class="row">
                <div class="col-lg-4 p-lg-0">
                    <div class="special-offer-left">
                        ...
                        <a href="{{ route('shop.list') }}" class="primary-btn1 style-2 hover-btn3">*Shop Now*</a>
                    </div>
                </div>
                        ...
                        <div id="slick2">
                                ...
                                <div class="product-card style-4">
                                    <div class="product-card-img double-img">
                                        <a href="{{ route('product.default') }}">
                                            <img src="{{ asset('assets/img/home1/sp-product-img-01.png') }}" alt=""
                                                class="img1">
                                            <img src="{{ asset('assets/img/home1/sp-product-img-05.png') }}" alt=""
                                                class="img2">
                                            <div class="batch">
                                                <span>-15%</span>
                                            </div>
                                    ...
                                    <div class="product-card-content">
                                        <h6><a href="{{ route('product.default') }}" class="hover-underline">Mystic
                                                Woods
                                                Aroma</a></h6>
                            ...
                            <div class="slide-item">
                                <div class="product-card style-4">
                                    <div class="product-card-img">
                                        <a href="{{ route('product.default') }}">
                                            <img src="{{ asset('assets/img/home1/sp-product-img-02.png') }}" alt="">
                                            <div class="batch">
                                                <span>-15%</span>
                                            </div>
                                        </a>
                                    ...
                                    <div class="product-card-content">
                                        <h6><a href="{{ route('product.default') }}" class="hover-underline">Dewy Fresh
                                                Face</a>
                                        </h6>
                                        <p><a href="{{ route('shop.list') }}">Pure Bliss</a></p>
                                        <p class="price">₹150.00 <del>₹200.00</del></p>
                                        <div class="rating">
                                            <ul>
                                                <li><i class="bi bi-star-fill"></i></li>
                            ...
                            <div class="slide-item">
                                <div class="product-card style-4">
                                    <div class="product-card-img">
                                        <a href="{{ route('product.default') }}">
                                            <img src="{{ asset('assets/img/home1/sp-product-img-03.png') }}" alt="">
                                            <div class="batch">
                                                <span>-15%</span>
                                            </div>
                                        </a>
                                    ...
                                    <div class="product-card-content">
                                        <h6><a href="{{ route('product.default') }}" class="hover-underline">Rose Petal
                                                Flush</a>
                                        </h6>
                                        <p><a href="{{ route('shop.list') }}">Velvet Tint</a></p>
                                        <p class="price">₹150.00 <del>₹200.00</del></p>
                                        <div class="rating">
                                            <ul>
                                                <li><i class="bi bi-star-fill"></i></li>
                            ...
                            <div class="slide-item">
                                <div class="product-card style-4">
                                    <div class="product-card-img">
                                        <a href="{{ route('product.default') }}">
                                            <img src="{{ asset('assets/img/home1/sp-product-img-04.png') }}" alt="">
                                            <div class="batch">
                                                <span>-15%</span>
                                            </div>
                                        </a>
                                    ...
                                    <div class="product-card-content">
                                        <h6><a href="{{ route('product.default') }}" class="hover-underline">Hydrating
                                                Waves</a>
                                        </h6>
                            ...
                            <div class="slide-item">
                                <div class="product-card style-4">
                                    ...
                                    <div class="product-card-content">
                                        <h6><a href="{{ route('product.default') }}" class="hover-underline">Velvet Red
                                                Charm</a>
                                        </h6>
                            ...
                            <div class="slide-item">
                                <div class="product-card style-4">
                                    <div class="product-card-img">
                                        <a href="{{ route('product.default') }}">
                                            <img src="{{ asset('assets/img/home1/sp-product-img-06.png') }}" alt="">
                                            <div class="batch">
                                                <span>-15%</span>
                                            </div>
                                        </a>
                                    ...
                                    <div class="product-card-content">
                                        <h6><a href="{{ route('product.default') }}" class="hover-underline">Intensive
                                                Cream</a>
                                        </h6>
                                        <p><a href="{{ route('shop.list') }}">Nectar Nouri</a></p>
                                        <p class="price">₹150.00 <del>₹200.00</del></p>
                                        <div class="rating">
                                            <ul>
                                                <li><i class="bi bi-star-fill"></i></li>
