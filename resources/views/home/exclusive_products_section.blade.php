...
<div class="exclusive-product-section mb-110">
   <img src="{{ asset('assets/img/home1/icon/vector-3.svg') }}" alt="" class="vector3">
   <img src="{{ asset('assets/img/home1/icon/vector-4.svg') }}" alt="" class="vector4">
   <div class="container">
                           ...
                           <div class="exclusive-product-right">
                              <div class="product-right-img hover-img">
                                 <a href="{{ route('product.default') }}">
                                    <img src="{{ asset('assets/img/home1/ex-product-img-01.png') }}" alt="">
                                 </a>
                              </div>
                              <div class="product-right-content">
                                 <a href="{{ route('shop.list') }}">
                                    <img src="{{ asset('assets/img/home1/loreal-logo.png') }}" alt="">
                                 </a>
                                 <div class="star-bg">
                                    <img src="{{ asset('assets/img/home1/star.svg') }}" alt="">
                                    <span>NEW</span>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                           <div class="exclusive-product-right">
                              <div class="product-right-img hover-img">
                                 <a href="{{ route('product.default') }}">
                                    <img src="{{ asset('assets/img/home1/ex-product-img-02.png') }}" alt="">
                                 </a>
                              </div>
                              <div class="product-right-content">
                                 <a href="{{ route('shop.list') }}">
                     ...
                     <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                           <div class="exclusive-product-right">
                              <div class="product-right-img hover-img">
                                 <a href="{{ route('product.default') }}">
                                    <img src="{{ asset('assets/img/home1/ex-product-img-03.png') }}" alt="">
                                 </a>
                              </div>
                              <div class="product-right-content">
                                 <a href="{{ route('shop.list') }}">
