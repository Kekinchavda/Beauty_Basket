         ...
         <div class="row gy-4">
            <div class="col-lg-4 col-md-6">
               <div class="product-card hover-btn">
                  <div class="product-card-img double-img">
                     ...
                     <div class="overlay">
                        <div class="cart-area">
                           <a href="{{ route('cart') }}" class="hover-btn3 add-cart-btn"><i class="bi bi-bag-check"></i> Add To
                              Cart</a>
                        </div>
                     </div>
                  ...
                  <div class="product-card-content">
                     <h6><a href="{{ route('product.default') }}" class="hover-underline">Poutsicle Hydrating Lip Stain.</a></h6>
            ...
            <div class="col-lg-4 col-md-6">
               <div class="product-card hover-btn">
                  ...
                  <div class="product-card-content">
                     <h6><a href="{{ route('product.default') }}" class="hover-underline">Velvet Red Charm</a></h6>
                     <p><a href="{{ route('shop.list') }}">Aqua Kiss</a></p>
                     <p class="price">₹150.00 <del>₹200.00</del></p>
                     <div class="rating">
                        <ul>
                           <li><i class="bi bi-star-fill"></i></li>
            ...
            <div class="col-lg-4 col-md-6">
               <div class="product-card hover-btn">
                  ...
                  <div class="product-card-content">
                     <h6><a href="{{ route('product.default') }}" class="hover-underline">Hydrating Waves</a></h6>
                     <p><a href="{{ route('shop.list') }}">Sea Breeze</a></p>
            ...
            <div class="col-lg-4 col-md-6">
               <div class="product-card hover-btn">
                  ...
                  <div class="product-card-content">
                     <h6><a href="{{ route('product.default') }}" class="hover-underline">Organic Jojoba Blend</a></h6>
            ...
            <div class="col-lg-4 col-md-6">
               <div class="product-card hover-btn">
                  ...
                  <div class="product-card-content">
                     <h6><a href="{{ route('product.default') }}" class="hover-underline">Nourishing Herbal Cleanse</a></h6>
                  ...
                  <div class="row gy-4">
                        ...
                        <div class="shop-details-img">
                           ...
                           <div class="nav nav-pills" id="view-tab" role="tablist" aria-orientation="vertical">
                              <button class="nav-link active" id="view-pills-img1-tab" data-bs-toggle="pill"
                                 data-bs-target="#view-pills-img1" type="button" role="tab" aria-controls="view-pills-img1"
                                 aria-selected="true">
                              ...
                              <button class="nav-link" id="view-pills-img2-tab" data-bs-toggle="pill"
                                 data-bs-target="#view-pills-img2" type="button" role="tab" aria-controls="view-pills-img2"
                                 aria-selected="false">
                              ...
                              <button class="nav-link" id="view-pills-img3-tab" data-bs-toggle="pill"
                                 data-bs-target="#view-pills-img3" type="button" role="tab" aria-controls="view-pills-img3"
                                 aria-selected="false">
                              ...
                              <button class="nav-link" id="view-pills-img4-tab" data-bs-toggle="pill"
                                 data-bs-target="#view-pills-img4" type="button" role="tab" aria-controls="view-pills-img4"
                                 aria-selected="false">
                     ...
                     <div class="col-lg-6">
                        <div class="shop-details-content">
                           ...
                           <p>Aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos only placerat
                              felis non aliquam.Mauris nec justo vitae ante auctor tol euismod sit amet Praesent commodo at
                           ...
                           <div class="shop-details-btn">
                              ...
                              <a href="{{(route('cart'))}}" class="primary-btn1 style-3 hover-btn4">*Add to Cart*</a>
                           </div>
