         ...
         <div class="row gy-4 justify-content-center">
            <div class="col-lg-3">
               <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  <button class="nav-link active" id="v-Korean-tab" data-bs-toggle="pill" data-bs-target="#v-Korean"
                     type="button" role="tab" aria-controls="v-Korean" aria-selected="true">
                     Korean Product
                     <span>(30)</span>
                  </button>
                  <button class="nav-link" id="v-makeup-tab" data-bs-toggle="pill" data-bs-target="#v-makeup" type="button"
                     role="tab" aria-controls="v-makeup" aria-selected="false">
                     Makeup
                     <span>(40)</span>
                  </button>
                  <button class="nav-link" id="v-skin-care-tab" data-bs-toggle="pill" data-bs-target="#v-skin-care"
                     type="button" role="tab" aria-controls="v-skin-care" aria-selected="false">
                     Skin Care
                     <span>(32)</span>
                  </button>
                  ...
                  <button class="nav-link" id="v-fragrance-tab" data-bs-toggle="pill" data-bs-target="#v-fragrance"
                     type="button" role="tab" aria-controls="v-fragrance" aria-selected="false">
                     Fragrance
                     <span>(19)</span>
                  </button>
                  <button class="nav-link" id="v-health-tab" data-bs-toggle="pill" data-bs-target="#v-health" type="button"
                     role="tab" aria-controls="v-health" aria-selected="false">
                     Health & Care
                     <span>(21)</span>
                  </button>
                  <button class="nav-link" id="v-accessories-tab" data-bs-toggle="pill" data-bs-target="#v-accessories"
                     type="button" role="tab" aria-controls="v-accessories" aria-selected="false">
                     Accessories
                     <span>(36)</span>
                  </button>
                  <button class="nav-link" id="v-kids-tab" data-bs-toggle="pill" data-bs-target="#v-kids" type="button"
                     role="tab" aria-controls="v-kids" aria-selected="false">
                     Kids & Baby
                     <span>(55)</span>
                  </button>
                  <button class="nav-link" id="v-skin-care2-tab" data-bs-toggle="pill" data-bs-target="#v-skin-care2"
                     type="button" role="tab" aria-controls="v-skin-care2" aria-selected="false">
                     Skin Care
                     <span>(68)</span>
                  </button>
               </div>
               <div class="offer-img hover-img">
                  ...
                  <div class="discount-buy">
                     ...
                     <a href="{{ route('shop.list') }}" class="buy-btn hover-btn4">*Buy Now*</a>
                  </div>
               </div>
            </div>
            <div class="col-lg-9">
                     ...
                     <div class="row gy-4">
                           ...
                           <div class="product-card style-2 hover-btn">
                              <div class="product-card-img double-img">
                                 <a href="{{ route('product.default') }}">
                                    <img src="{{ asset('assets/img/home1/product-img-7.png') }}" alt="" class="img1">
                                    <img src="{{ asset('assets/img/home1/product-img-22.png') }}" alt="" class="img2">
                                    <div class="batch">
                                       <span>-15%</span>
                                    </div>
                                 </a>
                                 <div class="overlay">
                                    <div class="cart-area">
                                       <a href="{{ route('cart') }}" class="hover-btn3 add-cart-btn"><i class="bi bi-bag-check"></i>
                                          Add To Cart</a>
                                    </div>
                                 </div>
                              </div>
                              <div class="product-card-content">
                                 <h6><a href="{{ route('product.default') }}" class="hover-underline">Youthful Renewal Formula</a>
                                 </h6>
                                 <p><a href="{{ route('shop.list') }}">Crystal Gleam</a></p>
                        ...
                        <div class="col-xl-4 col-md-6">
                           <div class="product-card style-2 hover-btn">
                              ...
                              <div class="product-card-content">
                                 <h6><a href="{{ route('product.default') }}" class="hover-underline">Vivid Eye Pencil</a></h6>
                        ...
                        <div class="col-xl-4 col-md-6">
                           <div class="product-card style-2 hover-btn">
                              ...
                              <div class="product-card-content">
                                 <h6><a href="{{ route('product.default') }}" class="hover-underline">Firming Night Cream</a></h6>
                                 <p><a href="{{ route('shop.list') }}">Crystal</a></p>
                                 <p class="price">₹150.00 <del>₹200.00</del></p>
                                 <div class="rating">
                                    <ul>
                                       <li><i class="bi bi-star-fill"></i></li>
                        ...
                        <div class="col-xl-4 col-md-6">
                           <div class="product-card style-2 hover-btn">
                              <div class="product-card-img">
                                 <a href="{{ route('product.default') }}">
                                    <img src="{{ asset('assets/img/home1/product-img-10.png') }}" alt="">
                                    <div class="batch">
                                       <span>-15%</span>
                                    </div>
                                 </a>
                              ...
                              <div class="product-card-content">
                                 <h6><a href="{{ route('product.default') }}" class="hover-underline">Brightening Cream Complex</a>
                                 </h6>
                                 <p><a href="{{ route('shop.list') }}">Radiant</a></p>
                                 <p class="price">₹150.00 <del>₹200.00</del></p>
                                 <div class="rating">
                                    <ul>
                                       <li><i class="bi bi-star-fill"></i></li>
                        ...
                        <div class="col-xl-4 col-md-6">
                           <div class="product-card style-2 hover-btn">
                              <div class="product-card-img double-img">
                                 <a href="{{ route('product.default') }}">
                                    <img src="{{ asset('assets/img/home1/product-img-11.png') }}" alt="" class="img1">
                                    <img src="{{ asset('assets/img/home1/product-img-14.png') }}" alt="" class="img2">
                                    <div class="batch">
                                       <span>-15%</span>
                                    </div>
                                 </a>
                              ...
                              <div class="product-card-content">
                                 <h6><a href="{{ route('product.default') }}" class="hover-underline">Age-Defying Miracle</a></h6>
                                 <p><a href="{{ route('shop.list') }}">Radiance</a></p>
                                 <p class="price">₹150.00 <del>₹200.00</del></p>
                                 <div class="rating">
                                    <ul>
                                       <li><i class="bi bi-star-fill"></i></li>
                        ...
                        <div class="col-xl-4 col-md-6">
                           <div class="product-card style-2 hover-btn">
                              <div class="product-card-img">
                                 <a href="{{ route('product.default') }}">
                                    <img src="{{ asset('assets/img/home1/product-img-12.png') }}" alt="">
                                    <div class="batch">
                                       <span>-15%</span>
                                    </div>
                                 </a>
                              ...
                              <div class="product-card-content">
                                 <h6><a href="{{ route('product.default') }}" class="hover-underline">Oil-Control Pressed</a></h6>
                                 <p><a href="{{ route('shop.list') }}">Whispering</a></p>
                                 <p class="price">₹150.00 <del>₹200.00</del></p>
                                 <div class="rating">
                                    <ul>
                                       <li><i class="bi bi-star-fill"></i></li>
