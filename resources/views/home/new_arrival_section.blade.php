                  ...
                  <div class="swiper-wrapper">
                        ...
                        <div class="product-card hover-btn">
                           <div class="product-card-img double-img">
                              <a href="{{ route('product.default') }}">
                                 <img src="{{ asset('assets/img/home1/product-img-13.png') }}" alt="" class="img1">
                                 <img src="{{ asset('assets/img/home1/product-img-12.png') }}" alt="" class="img2">
                                 <div class="countdown-timer">
                                    <ul data-countdown="2023-10-23 12:00:00">
                                       <li class="times" data-days="00">60 <span>Days</span> <span>D</span></li>
                                       <li>
                                          :
                                       </li>
                                       <li class="times" data-hours="00">16 <span>Hours</span> <span>H</span></li>
                                       <li>
                                          :
                                       </li>
                                       <li class="times" data-minutes="00">40 <span>Minutes</span> <span>M</span></li>
                                       <li>
                                          :
                                       </li>
                                       <li class="times" data-seconds="00">34 <span>Seconds</span> <span>S</span></li>
                                    </ul>
                                 </div>
                                 <div class="batch">
                                    <span>-15%</span>
                     ...
                     <div class="swiper-slide">
                        <div class="product-card hover-btn">
                           <div class="product-card-img">
                              <a href="{{ route('product.default') }}">
                                 <img src="{{ asset('assets/img/home1/product-img-14.png') }}" alt="">
                                 <div class="batch">
                                    <span>-15%</span>
                                 </div>
                              </a>
                     ...
                     <div class="swiper-slide">
                        <div class="product-card hover-btn">
                           <div class="product-card-img double-img">
                              <a href="{{ route('product.default') }}">
                                 <img src="{{ asset('assets/img/home1/product-img-15.png') }}" alt="" class="img1">
                                 <img src="{{ asset('assets/img/home1/product-img-18.png') }}" alt="" class="img2">
                                 <div class="batch">
                                    <span>-15%</span>
                                 </div>
                              </a>
                     ...
                     <div class="swiper-slide">
                        <div class="product-card hover-btn">
                           <div class="product-card-img">
                              <a href="{{ route('product.default') }}">
                                 <img src="{{ asset('assets/img/home1/product-img-16.png') }}" alt="">
                                 <div class="batch">
                                    <span>-15%</span>
                                 </div>
                              </a>
