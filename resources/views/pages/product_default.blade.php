...
@section('content')
    ...
    <x-breadcrumb :breadcrumbs="[
            ['title' => 'Product Default', 'url' => route('product.default')],
        ]" />
            ...
            <div class="row gy-5">
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-img1" role="tabpanel">
                                <div class="shop-details-tab-img product-img--main" data-scale="1.4"
                                    data-image="./assets/img/inner-page/shop-details-tab-img1.png">
                                    <img src="assets/img/inner-page/shop-details-tab-img1.png" alt="">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="v-pills-img2" role="tabpanel">
                                <div class="shop-details-tab-img product-img--main" data-scale="1.4"
                                    data-image="./assets/img/inner-page/shop-details-tab-img2.png">
                            ...
                            <div class="tab-pane fade" id="v-pills-img3" role="tabpanel" aria-labelledby="v-pills-img3-tab">
                                <div class="shop-details-tab-img product-img--main" data-scale="1.4"
                                    data-image="./assets/img/inner-page/shop-details-tab-img3.png">
                            ...
                            <div class="tab-pane fade" id="v-pills-img4" role="tabpanel" aria-labelledby="v-pills-img4-tab">
                                <div class="shop-details-tab-img product-img--main" data-scale="1.4"
                                    data-image="./assets/img/inner-page/shop-details-tab-img4.png">
                ...
                <div class="col-lg-6">
                    <div class="shop-details-content">
                        ...
                        <p>Aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos only placerat felis
                            non aliquam.Mauris nec justo vitae ante auctor tol euismod sit amet Praesent commodo at massa
                            eget suscipit. Utani vitae enim velit.</p>
                            ...
                            <div>
                                ...
                                <div class="quantity-color">
                                    ...
                                    <ul class="product-size">
                                        <li class="select-wrap selected">250 ml</li>
                                        <li class="select-wrap">500 ml</li>
                                        <li class="select-wrap">1000 ml</li>
                                        <li class="select-wrap">1500 ml</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="accordion-body">
                                        <div class="product-description">
                                            <p> The Radiant Luxe Lipstick is the epitome of elegance and sophistication,
                                                designed to empower you with confidence and allure. This luxurious lipstick
                                                collection offers an array of shades that range from bold
                                                and vibrant to subtle and timeless, ensuring there's a perfect hue for every
                                                occasion and mood.</p>
                                            <h6>Key Features:</h6>
                                            <ul>
                                                <li>
                                                    <span>Rich Pigmentation:</span> Our lipstick formula boasts intense
                                                    color payoff with a single stroke, delivering a bold statement that
                                                    lasts all day.
                                                </li>
                                                <li>
                                                    <span>Hydrating Formula:</span> Infused with nourishing botanical
                                                    extracts and oils, the formula keeps your lips hydrated and supple,
                                                    preventing any dryness or flakiness.
                                                </li>
                                                <li>
                                                    <span>Long-lasting:</span> Experience the confidence of a long-lasting
                                                    lip color that stays put even through your busiest moments.
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                        ...
                                                        <ul class="author-comment mb-60">
                                                            <li>
                                                                <div class="author-img">
                                                                    <img src="assets/img/inner-page/comment-author1.png "
                                                                        alt="">
                                                                </div>
                                                                <div class="comment-content">
                                                                    <div class="author-post style-2">
                                                                        <div class="author-info">
                                                                            <h5>Polard Girdet, <span> 02 June,2023</span>
                                                                            </h5>
                                                                        </div>
                                                                        <ul class="rating">
                                                                    ...
                                                                    <p>Odio tellus, dignissim fermentumara purus nec,
                                                                        consequat dapibus metus.Vivamusut urna world classo
                                                                        mauris, faucibus at egestas quis, fermentum egetonav
                                                                        neque.</p>
                                                            ...
                                                            <li>
                                                                <div class="author-img">
                                                                    <img src="assets/img/inner-page/comment-author2.png "
                                                                        alt="">
                                                                </div>
                                                                <div class="comment-content">
                                                                    <div class="author-post style-2">
                                                                        <div class="author-info">
                                                                            <h5>James Jordan, <span> 04 June,2023</span>
                                                                            </h5>
                                                                        </div>
                                                                        <ul class="rating">
                                                                            <li><i class="bi bi-star-fill"></i></li>
                                                                    ...
                                                                    <p>Odio tellus, dignissim fermentumara purus nec,
                                                                        consequat dapibus metus.Vivamusut urna world classo
                                                                        mauris, faucibus at egestas quis.</p>
                                                                    <a href="#" class="replay-btn">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="14"
                                                                            height="11" viewBox="0 0 14 11">
                                                                            <path
                                                        ...
                                                        <form class="contact-form">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 pt-30">
                                                                    <button type="submit"
                                                                        class="primary-btn1 hover-btn3">Submit</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
