                    ...
                    <div class="added-product-summary mb-30">
                        ...
                        <ul class="added-products">
                            <li class="single-product">
                                <div class="product-area">
                                    <div class="product-img">
                                        <img src="{{ asset('assets/img/inner-page/checkout-product-img1.png') }}" alt="">
                                    </div>
                            ...
                            <li class="single-product">
                                <div class="product-area">
                                    <div class="product-img">
                                        <img src="{{ asset('assets/img/inner-page/checkout-product-img2.png') }}" alt="">
                                    </div>
                                    <div class="product-info">
                            ...
                            <li class="single-product">
                                <div class="product-area">
                                    <div class="product-img">
                                        <img src="{{ asset('assets/img/inner-page/checkout-product-img3.png') }}" alt="">
                                    </div>
                                    <div class="product-info">
                            ...
                            <ul class="payment-list">
                                <li class="check-payment">
                                    <div class="form-check payment-check">
                                        ...
                                        <p class="para">Please send a check to Store Name, Store Street, Store State /
                                            Country, Store Postcode.</p>
                                    </div>
                                    <div class="checked">
                                    </div>
                                </li>
                                ...
                                <li class="paypal">
                                    <div class="form-check payment-check paypal">
                                        <h6>Paypal</h6>
                                        <img src="{{ asset('assets/img/inner-page/payment.png') }}" alt="">
