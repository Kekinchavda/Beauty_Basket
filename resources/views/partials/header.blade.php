        ...
        <div class="row">
            <div class="col-lg-12 d-flex align-items-center justify-content-between gap-3">
                ...
                <div class="company-logo">
                    <a href="{{route('index')}}"><img style="width:40px; height:auto;"
                            src="{{ asset('assets/img/file.enc') }}" alt=""></a>
                </div>
...
<header class="header-area">
    <div
        ...
        <div class="header-logo d-lg-none d-flex">
            <a href="{{ route('index') }}"><img width="40px" height="auto" alt="image" class="img-fluid"
                    src="{{ asset('assets/img/file.enc') }}"></a>
        </div>
        <div class="category-dropdown">
            ...
            <div class="category-menu">
                <!-- Start Category name from Enums -->
                <ul>
                    @foreach(\App\Enums\CategoryMenuType::cases() as $menu)
                        <li class="{{ $menu->hasChildren() ? 'category-has-child' : '' }}">
                            <a href="{{ $menu->route() ?? '#' }}">
                                {{ $menu->label() }}
                            </a>
                ...
                <!-- End Category name from Enums -->
            </div>
        </div>
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <a href="{{ route('index') }}"><img alt="image" width="40px" height="auto"
                            src="{{ asset('assets/img/file.enc') }}"></a>
                </div>
            </div>
            <ul class="menu-list">
                <!-- enums  -->
                    @foreach(\App\Enums\MegaMenuType::cases() as $menu)
                        <li class="menu-item-has-children position-inherit">
                            <a href="#" class="drop-down">{{ $menu->label() }}</a>
                            <i class="bi bi-plus dropdown-icon"></i>

                            <div class="mega-menu2" style="background-image: url('{{ $menu->background() }}');">
                                <div class="megamenu-wrap">
                                    <ul class="menu-row">

                                        @foreach($menu->items() as $item)
                                            <li class="menu-single-item">
                                                <a href="{{ route('shop.list', ['category' => Str::slug($item)]) }}">
                                    ...
                                    <div class="all-product">
                                        <a class="hover-underline" href="{{ route('shop.list') }}">
                                            *View All Product
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <ul class="menu-row">
                                        ...
                                        <li class="menu-single-item">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="{{ route('shop.list') }}">Filter Hidden</a>
                                                </li>
                                                <li>
                                            ...
                                            <ul class="menu-rows">
                                                <li class="menu-single-item">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="{{ route('whistlist') }}">Wishlist</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="menu-single-item">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="{{ route('shop.list') }}">Pagination</a>
                                                </li>
                                                <li>
                                    ...
                                    <ul class="menu-row">
                                        <li class="menu-single-item">
                                            ...
                                            <ul class="menu-rows">
                                                <li class="menu-single-item">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="{{ route('product.default') }}">Tab Default</a>
                                                        </li>
                                                        <li>
                                        ...
                                        <li class="menu-single-item">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="{{ route('product.default') }}">Image Zoom</a>
                                                </li>
                                            </ul>
                    ...
                    <form class="mobile-menu-form">
                        ...
                        <div class="email pt-20 d-flex align-items-center">
                            ...
                            <div class="email-info">
                                <span>Email Now</span>
                                <h6><a href="/cdn-cgi/l/email-protection#55302d3438253930153238343c397b363a38"><span
                                            class="__cf_email__"
                                            data-cfemail="b2d7cad3dfc2ded7f2d5dfd3dbde9cd1dddf">[email&#160;protected]</span></a>
                                </h6>
                            </div>
                        </div>
                    </form>
                ...
                <div class="cart-menu">
                    <div class="cart-body">
                        <ul>
                            <li class="single-item">
                                <div class="item-area">
                                    <div class="item-img">
                                        <img src="{{ asset('assets/img/home1/cart-img-1.png') }}" alt="">
                                    </div>
                            ...
                            <li class="single-item">
                                <div class="item-area">
                                    <div class="item-img">
                                        <img src="{{ asset('assets/img/home1/cart-img-2.png') }}" alt="">
                                    </div>
                                    <div class="content-and-quantity">
                                        <div class="content">
                                            <div
                    ...
                    <div class="cart-footer">
                        ...
                        <div class="footer-button">
                            <ul>
                                <li><a class="primary-btn1 hover-btn4" href="{{ route('shop.list') }}">Continue Shopping</a>
                                </li>
