            ...
            <ul class="menu-list">
                <li class="menu-item-has-children position-inherit">
                    ...
                    <div class="mega-menu2"
                        style="background-image: url('{{ asset('assets/img/home1/megamenu2-face-bg.png') }}');">
                ...
                <li class="menu-item-has-children position-inherit for-dropdown">
                    <a href="#" class="drop-down">Shop<i
                            class="bi bi-plus dropdown-icon d-lg-flex d-none"></i></a>
                ...
                <div class="cart-menu">
                    ...
                    <div class="cart-footer">
                        ...
                        <div class="footer-button">
                            <ul>
                                <li><a class="primary-btn1 hover-btn4" href="shop-list.html">Continue Shopping</a>
                                </li>
