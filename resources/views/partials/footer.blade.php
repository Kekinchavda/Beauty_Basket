            ...
            <div class="row">
                <div
                    ...
                    <div class="footer-left">
                        <p>©Copyright {{ date('Y') }} Beauty Basket | Design By <a
                                href="https://www.linkedin.com/in/devnex-solutions/">DevNex Solutions</a></p>
                    </div>
                    <div class="footer-logo">
                        <a href="index.html"><img style="width:40px; height:auto;" src="{{ asset('assets/img/file.enc') }}" alt=""></a>
                    </div>
